...
class TaskComponent extends Rete.Component {
    ...
    builder(node) {
      ...
      var te = new Rete.Output("transition_event", "Transition Event", transition_socket);
...
export default async function(container) {
    var components = [new TaskComponent(), new ChoiceComponent(), new ChoiceEventComponent(), new CatchEventComponent(), new TransitionEventComponent()];
